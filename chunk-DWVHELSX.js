import{$ as je,$a as k,A as er,Aa as lp,Ab as pt,B as Hn,Ba as cp,Bb as nt,C as Rl,Ca as up,D as Zd,Da as dp,Db as pe,E as Qd,Ea as pp,Eb as Gn,F as Ml,Fa as Di,Fb as ee,G as Xd,Ga as Aa,Gb as te,H as at,Ha as hp,Hb as Kl,I as Jd,Ia as fp,Ib as yp,J as st,Ja as y,Jb as Ut,K as le,Ka as xi,Kb as De,L as hn,La as nr,Lb as $e,M as I,Ma as mp,Mb as vt,N as ie,Na as $t,Nb as _p,O as ep,Oa as B,Ob as rr,P as Z,Pa as gp,Pb as or,Q as Ll,Qa as Ei,Qb as ar,R as z,Ra as Vl,Rb as ue,S,Sb as Cp,T as zn,Ta as vp,Tb as Vt,Ua as Ia,Ub as Fa,V as tp,Va as W,W as qn,Wa as re,X as Pt,Xa as ne,Xb as Ra,Y as Qe,Ya as ka,Z as K,Za as U,_ as Y,_b as wp,a as Wd,aa as R,ab as jl,ac as Me,b as Gd,ba as Ol,bb as ir,bc as Le,c as Kd,ca as Qt,cb as bp,d as Il,da as Nl,db as oo,dc as mn,e as kl,eb as Hl,ec as Sp,f as Je,fa as Ta,fb as zl,g as Nt,ga as G,gb as M,gc as Ct,h as An,ha as gt,hb as b,hc as Dp,i as Ge,ia as Pl,ib as Wn,ic as xp,j as q,ja as fn,jb as _t,jc as Ep,k as to,ka as dt,kb as Xt,kc as j,l as jn,la as Be,lb as Q,lc as wt,m as Yd,ma as np,mb as lt,mc as St,na as Bl,nb as ql,nc as Dt,o as me,oa as ip,ob as Wl,oc as ao,p as xa,pa as Bt,pb as Gl,pc as Tp,q as mt,qb as x,r as no,ra as $l,rb as T,s as io,sa as rp,sb as L,sc as so,t as Ji,ta as Ul,tb as et,tc as Ti,u as Ea,ua as op,ub as tt,v as pn,va as ro,vb as He,vc as Kn,w as wi,wa as Si,wb as Ae,wc as Ma,x as Yt,xa as tr,xc as Ai,y as Fl,ya as ap,yb as J,z as Zt,za as sp,zb as D}from"./chunk-I5MMSQAM.js";import{a as E,b as _e,e as Wb,f as Gb,h as Ce}from"./chunk-C3GRVDOV.js";var km=Wb((Im,Cu)=>{"use strict";(function(t){function i(){var n=t();return n.default||n}if(typeof Im=="object"&&typeof Cu=="object")Cu.exports=i();else if(typeof define=="function"&&define.amd)define(i);else{var e=typeof globalThis<"u"?globalThis:typeof global<"u"?global:typeof self<"u"?self:this||{};e.prettierPlugins=e.prettierPlugins||{},e.prettierPlugins.html=i()}})(function(){"use strict";var t=Object.defineProperty,i=Object.getOwnPropertyDescriptor,e=Object.getOwnPropertyNames,n=Object.prototype.hasOwnProperty,r=o=>{throw TypeError(o)},s=(o,a,c)=>a in o?t(o,a,{enumerable:!0,configurable:!0,writable:!0,value:c}):o[a]=c,l=(o,a)=>{for(var c in a)t(o,c,{get:a[c],enumerable:!0})},d=(o,a,c,u)=>{if(a&&typeof a=="object"||typeof a=="function")for(let p of e(a))!n.call(o,p)&&p!==c&&t(o,p,{get:()=>a[p],enumerable:!(u=i(a,p))||u.enumerable});return o},h=o=>d(t({},"__esModule",{value:!0}),o),m=(o,a,c)=>s(o,typeof a!="symbol"?a+"":a,c),v=(o,a,c)=>a.has(o)||r("Cannot "+c),C=(o,a,c)=>(v(o,a,"read from private field"),c?c.call(o):a.get(o)),w=(o,a,c)=>a.has(o)?r("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(o):a.set(o,c),A=(o,a,c,u)=>(v(o,a,"write to private field"),u?u.call(o,c):a.set(o,c),c),$={};l($,{languages:()=>Mv,options:()=>Ov,parsers:()=>md,printers:()=>zb});var N=(o,a,c,u)=>{if(!(o&&a==null))return a.replaceAll?a.replaceAll(c,u):c.global?a.replace(c,u):a.split(c).join(u)},O=N,ge="string",Ee="array",ve="cursor",Oe="indent",Rt="align",yt="trim",On="group",Dn="fill",Nn="if-break",Pn="indent-if-break",hi="line-suffix",fi="line-suffix-boundary",Mt="line",Bn="label",$n="break-parent",mi=new Set([ve,Oe,Rt,yt,On,Dn,Nn,Pn,hi,fi,Mt,Bn,$n]),$i=(o,a,c)=>{if(!(o&&a==null))return Array.isArray(a)||typeof a=="string"?a[c<0?a.length+c:c]:a.at(c)},dn=$i;function Ui(o){if(typeof o=="string")return ge;if(Array.isArray(o))return Ee;if(!o)return;let{type:a}=o;if(mi.has(a))return a}var gi=Ui,Vi=o=>new Intl.ListFormat("en-US",{type:"disjunction"}).format(o);function ji(o){let a=o===null?"null":typeof o;if(a!=="string"&&a!=="object")return`Unexpected doc '${a}', 
...
Expected it to be ${u}.`}var Xo=class extends Error{name="InvalidDocError";constructor(o){super(ji(o)),this.doc=o}},Jo=Xo;function $r(o,a){if(typeof o=="string")return a(o);let c=new Map;return u(o);function u(f){if(c.has(f))return c.get(f);let g=p(f);return c.set(f,g),g}function p(f){switch(gi(f)){case Ee:return a(f.map(u));case Dn:return a(_e(E({},f),{parts:f.parts.map(u)}));case Nn:return a(_e(E({},f),{breakContents:u(f.breakContents),flatContents:u(f.flatContents)}));case On:{let{expandedStates:g,contents:_}=f;return g?(g=g.map(u),_=g[0]):_=u(_),a(_e(E({},f),{contents:_,expandedStates:g}))}case Rt:case Oe:case Pn:case Bn:case hi:return a(_e(E({},f),{contents:u(f.contents)}));case ge:case ve:case yt:case fi:case Mt:case $n:return a(f);default:throw new Jo(f)}}}function ft(o,a=tg){return $r(o,c=>typeof c=="string"?zi(a,c.split(`
`)):c)}var Ur=()=>{},xn=Ur,ea=Ur,Qs=Ur;function Lt(o){return xn(o),{type:Oe,contents:o}}function ta(o,a){return xn(a),{type:Rt,contents:a,n:o}}function Pe(o,a={}){return xn(o),ea(a.expandedStates,!0),{type:On,id:a.id,contents:o,break:!!a.shouldBreak,expandedStates:a.expandedStates}}function Xs(o){return ta(Number.NEGATIVE_INFINITY,o)}function Js(o){return ta({type:"root"},o)}function na(o){return Qs(o),{type:Dn,parts:o}}function Hi(o,a="",c={}){return xn(o),a!==""&&xn(a),{type:Nn,breakContents:o,flatContents:a,groupId:c.groupId}}function el(o,a){return xn(o),{type:Pn,contents:o,groupId:a.groupId,negate:a.negate}}var vi={type:$n},tl={type:Mt,hard:!0},nl={type:Mt,hard:!0,literal:!0},Ne={type:Mt},Ze={type:Mt,soft:!0},Fe=[tl,vi],tg=[nl,vi];function zi(o,a){xn(o),ea(a);let c=[];for(let u=0;u<a.length;u++)u!==0&&c.push(o),c.push(a[u]);return c}var ia="'",Tu='"';function ng(o,a){let c=a===!0||a===ia?ia:Tu,u=c===ia?Tu:ia,p=0,f=0;for(let g of o)g===c?p++:g===u&&f++;return p>f?u:c}var ig=ng;function rg(o){if(typeof o!="string")throw new TypeError("Expected a string");return o.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}var Wt,og=class{constructor(o){w(this,Wt),A(this,Wt,new Set(o))}getLeadingWhitespaceCount(o){let a=C(this,Wt),c=0;for(let u=0;u<o.length&&a.has(o.charAt(u));u++)c++;return c}getTrailingWhitespaceCount(o){let a=C(this,Wt),c=0;for(let u=o.length-1;u>=0&&a.has(o.charAt(u));u--)c++;return c}getLeadingWhitespace(o){let a=this.getLeadingWhitespaceCount(o);return o.slice(0,a)}getTrailingWhitespace(o){let a=this.getTrailingWhitespaceCount(o);return o.slice(o.length-a)}hasLeadingWhitespace(o){return C(this,Wt).has(o.charAt(0))}hasTrailingWhitespace(o){return C(this,Wt).has(dn(!1,o,-1))}trimStart(o){let a=this.getLeadingWhitespaceCount(o);return o.slice(a)}trimEnd(o){let a=this.getTrailingWhitespaceCount(o);return o.slice(0,o.length-a)}trim(o){return this.trimEnd(this.trimStart(o))}split(o,a=!1){let c=`[${rg([...C(this,Wt)].join(""))}]+`,u=new RegExp(a?`(${c})`:c,"u");return o.split(u)}hasWhitespaceCharacter(o){let a=C(this,Wt);return Array.prototype.some.call(o,c=>a.has(c))}hasNonWhitespaceCharacter(o){let a=C(this,Wt);return Array.prototype.some.call(o,c=>!a.has(c))}isWhitespaceOnly(o){let a=C(this,Wt);return Array.prototype.every.call(o,c=>a.has(c))}};Wt=new WeakMap;var ag=og,sg=["	",`
`,"\f","\r"," "],lg=new ag(sg),En=lg,cg=class extends Error{name="UnexpectedNodeError";constructor(o,a,c="type"){super(`Unexpected ${a} node ${c}: ${JSON.stringify(o[c])}.`),this.node=o}},ug=cg;function dg(o){return o?.type==="front-matter"}var ra=dg,pg=new Set(["sourceSpan","startSourceSpan","endSourceSpan","nameSpan","valueSpan","keySpan","tagDefinition","tokens","valueTokens","switchValueSourceSpan","expSourceSpan","valueSourceSpan"]),hg=new Set(["if","else if","for","switch","case"]);function Au(o,a){var c;if(o.type==="text"||o.type==="comment"||ra(o)||o.type==="yaml"||o.type==="toml")return null;if(o.type==="attribute"&&delete a.value,o.type==="docType"&&delete a.value,o.type==="angularControlFlowBlock"&&(c=o.parameters)!=null&&c.children)for(let u of a.parameters.children)hg.has(o.name)?delete u.expression:u.expression=u.expression.trim();o.type==="angularIcuExpression"&&(a.switchValue=o.switchValue.trim()),o.type==="angularLetDeclarationInitializer"&&delete a.value}Au.ignoredProperties=pg;var fg=Au;function mg(o,a){return Ce(this,null,function*(){if(o.language==="yaml"){let c=o.value.trim(),u=c?yield a(c,{parser:"yaml"}):"";return Js([o.startDelimiter,o.explicitLanguage,Fe,u,u?Fe:"",o.endDelimiter])}})}var gg=mg;function oa(o,a=!0){return[Lt([Ze,o]),a?Ze:""]}function qi(o,a){let c=o.type==="NGRoot"?o.node.type==="NGMicrosyntax"&&o.node.body.length===1&&o.node.body[0].type==="NGMicrosyntaxExpression"?o.node.body[0].expression:o.node:o.type==="JsExpressionRoot"?o.node:o;return c&&(c.type==="ObjectExpression"||c.type==="ArrayExpression"||(a.parser==="__vue_expression"||a.parser==="__vue_ts_expression")&&(c.type==="TemplateLiteral"||c.type==="StringLiteral"))}function Gt(o,a,c,u){return Ce(this,null,function*(){c=E({__isInHtmlAttribute:!0,__embeddedInHtml:!0},c);let p=!0;u&&(c.__onHtmlBindingRoot=(g,_)=>{p=u(g,_)});let f=yield a(o,c,a);return p?Pe(f):oa(f)})}function vg(o,a,c,u){let{node:p}=c,f=u.originalText.slice(p.sourceSpan.start.offset,p.sourceSpan.end.offset);return/^\s*$/u.test(f)?"":Gt(f,o,{parser:"__ng_directive",__isInHtmlAttribute:!1},qi)}var bg=vg,yg=(o,a)=>{if(!(o&&a==null))return a.toReversed||!Array.isArray(a)?a.toReversed():[...a].reverse()},_g=yg;function Cg(o){return Array.isArray(o)&&o.length>0}var il=Cg,Iu,ku,Fu,Ru,Mu,wg=((Iu=globalThis.Deno)==null?void 0:Iu.build.os)==="windows"||((Fu=(ku=globalThis.navigator)==null?void 0:ku.platform)==null?void 0:Fu.startsWith("Win"))||((Mu=(Ru=globalThis.process)==null?void 0:Ru.platform)==null?void 0:Mu.startsWith("win"))||!1;function Lu(o){if(o=o instanceof URL?o:new URL(o),o.protocol!=="file:")throw new TypeError(`URL must be a file URL: received "${o.protocol}"`);return o}function Sg(o){return o=Lu(o),decodeURIComponent(o.pathname.replace(/%(?![0-9A-Fa-f]{2})/g,"%25"))}function Dg(o){o=Lu(o);let a=decodeURIComponent(o.pathname.replace(/\//g,"\\").replace(/%(?![0-9A-Fa-f]{2})/g,"%25")).replace(/^\\*([A-Za-z]:)(\\|$)/,"$1\\");return o.hostname!==""&&(a=`\\\\${o.hostname}${a}`),a}function xg(o){return wg?Dg(o):Sg(o)}var Eg=xg,Tg=o=>String(o).split(/[/\\]/u).pop();function Ou(o,a){if(!a)return;let c=Tg(a).toLowerCase();return o.find(({filenames:u})=>u?.some(p=>p.toLowerCase()===c))??o.find(({extensions:u})=>u?.some(p=>c.endsWith(p)))}function Ag(o,a){if(a)return o.find(({name:c})=>c.toLowerCase()===a)??o.find(({aliases:c})=>c?.includes(a))??o.find(({extensions:c})=>c?.includes(`.${a}`))}function Nu(o,a){if(a){if(String(a).startsWith("file:"))try{a=Eg(a)}catch{return}if(typeof a=="string")return o.find(({isSupported:c})=>c?.({filepath:a}))}}function Ig(o,a){let c=_g(!1,o.plugins).flatMap(p=>p.languages??[]),u=Ag(c,a.language)??Ou(c,a.physicalFile)??Ou(c,a.file)??Nu(c,a.physicalFile)??Nu(c,a.file)??(a.physicalFile,void 0);return u?.parsers[0]}var aa=Ig,kg="inline",Pu={area:"none",base:"none",basefont:"none",datalist:"none",head:"none",link:"none",meta:"none",noembed:"none",noframes:"none",param:"block",rp:"none",script:"block",style:"none",template:"inline",title:"none",html:"block",body:"block",address:"block",blockquote:"block",center:"block",dialog:"block",div:"block",figure:"block",figcaption:"block",footer:"block",form:"block",header:"block",hr:"block",legend:"block",listing:"block",main:"block",p:"block",plaintext:"block",pre:"block",search:"block",xmp:"block",slot:"contents",ruby:"ruby",rt:"ruby-text",article:"block",aside:"block",h1:"block",h2:"block",h3:"block",h4:"block",h5:"block",h6:"block",hgroup:"block",nav:"block",section:"block",dir:"block",dd:"block",dl:"block",dt:"block",menu:"block",ol:"block",ul:"block",li:"list-item",table:"table",caption:"table-caption",colgroup:"table-column-group",col:"table-column",thead:"table-header-group",tbody:"table-row-group",tfoot:"table-footer-group",tr:"table-row",td:"table-cell",th:"table-cell",input:"inline-block",button:"inline-block",fieldset:"block",details:"block",summary:"block",marquee:"inline-block",source:"block",track:"block",meter:"inline-block",progress:"inline-block",object:"inline-block",video:"inline-block",audio:"inline-block",select:"inline-block",option:"block",optgroup:"block"},Fg="normal",Bu={listing:"pre",plaintext:"pre",pre:"pre",xmp:"pre",nobr:"nowrap",table:"initial",textarea:"pre-wrap"};function Rg(o){return o.type==="element"&&!o.hasExplicitNamespace&&!["html","svg"].includes(o.namespace)}var Vr=Rg,Mg=o=>O(!1,o,/^[\t\f\r ]*\n/gu,""),$u=o=>Mg(En.trimEnd(o)),Lg=o=>{let a=o,c=En.getLeadingWhitespace(a);c&&(a=a.slice(c.length));let u=En.getTrailingWhitespace(a);return u&&(a=a.slice(0,-u.length)),{leadingWhitespace:c,trailingWhitespace:u,text:a}};function Uu(o,a){return!!(o.type==="ieConditionalComment"&&o.lastChild&&!o.lastChild.isSelfClosing&&!o.lastChild.endSourceSpan||o.type==="ieConditionalComment"&&!o.complete||Wi(o)&&o.children.some(c=>c.type!=="text"&&c.type!=="interpolation")||al(o,a)&&!Tn(o,a)&&o.type!=="interpolation")}function sa(o){return o.type==="attribute"||!o.parent||!o.prev?!1:Og(o.prev)}function Og(o){return o.type==="comment"&&o.value.trim()==="prettier-ignore"}function Ot(o){return o.type==="text"||o.type==="comment"}function Tn(o,a){return o.type==="element"&&(o.fullName==="script"||o.fullName==="style"||o.fullName==="svg:style"||o.fullName==="svg:script"||o.fullName==="mj-style"&&a.parser==="mjml"||Vr(o)&&(o.name==="script"||o.name==="style"))}function Ng(o,a){return o.children&&!Tn(o,a)}function Pg(o,a){return Tn(o,a)||o.type==="interpolation"||Vu(o)}function Vu(o){return Yu(o).startsWith("pre")}function Bg(o,a){var c,u;let p=f();if(p&&!o.prev&&(u=(c=o.parent)==null?void 0:c.tagDefinition)!=null&&u.ignoreFirstLf)return o.type==="interpolation";return p;function f(){return ra(o)||o.type==="angularControlFlowBlock"?!1:(o.type==="text"||o.type==="interpolation")&&o.prev&&(o.prev.type==="text"||o.prev.type==="interpolation")?!0:!o.parent||o.parent.cssDisplay==="none"?!1:Wi(o.parent)?!0:!(!o.prev&&(o.parent.type==="root"||Wi(o)&&o.parent||Tn(o.parent,a)||ca(o.parent,a)||!Gg(o.parent.cssDisplay))||o.prev&&!Zg(o.prev.cssDisplay))}}function $g(o,a){return ra(o)||o.type==="angularControlFlowBlock"?!1:(o.type==="text"||o.type==="interpolation")&&o.next&&(o.next.type==="text"||o.next.type==="interpolation")?!0:!o.parent||o.parent.cssDisplay==="none"?!1:Wi(o.parent)?!0:!(!o.next&&(o.parent.type==="root"||Wi(o)&&o.parent||Tn(o.parent,a)||ca(o.parent,a)||!Kg(o.parent.cssDisplay))||o.next&&!Yg(o.next.cssDisplay))}function Ug(o,a){return Qg(o.cssDisplay)&&!Tn(o,a)}function la(o){return ra(o)||o.next&&o.sourceSpan.end&&o.sourceSpan.end.line+1<o.next.sourceSpan.start.line}function Vg(o){return ju(o)||o.type==="element"&&o.children.length>0&&(["body","script","style"].includes(o.name)||o.children.some(a=>Hg(a)))||o.firstChild&&o.firstChild===o.lastChild&&o.firstChild.type!=="text"&&zu(o.firstChild)&&(!o.lastChild.isTrailingSpaceSensitive||qu(o.lastChild))}function ju(o){return o.type==="element"&&o.children.length>0&&(["html","head","ul","ol","select"].includes(o.name)||o.cssDisplay.startsWith("table")&&o.cssDisplay!=="table-cell")}function rl(o){return Wu(o)||o.prev&&jg(o.prev)||Hu(o)}function jg(o){return Wu(o)||o.type==="element"&&o.fullName==="br"||Hu(o)}function Hu(o){return zu(o)&&qu(o)}function zu(o){return o.hasLeadingSpaces&&(o.prev?o.prev.sourceSpan.end.line<o.sourceSpan.start.line:o.parent.type==="root"||o.parent.startSourceSpan.end.line<o.sourceSpan.start.line)}function qu(o){return o.hasTrailingSpaces&&(o.next?o.next.sourceSpan.start.line>o.sourceSpan.end.line:o.parent.type==="root"||o.parent.endSourceSpan&&o.parent.endSourceSpan.start.line>o.sourceSpan.end.line)}function Wu(o){switch(o.type){case"ieConditionalComment":case"comment":case"directive":return!0;case"element":return["script","select"].includes(o.name)}return!1}function ol(o){return o.lastChild?ol(o.lastChild):o}function Hg(o){var a;return(a=o.children)==null?void 0:a.some(c=>c.type!=="text")}function Gu(o){if(o)switch(o){case"module":case"text/javascript":case"text/babel":case"text/jsx":case"application/javascript":return"babel";case"application/x-typescript":return"typescript";case"text/markdown":return"markdown";case"text/html":return"html";case"text/x-handlebars-template":return"glimmer";default:if(o.endsWith("json")||o.endsWith("importmap")||o==="speculationrules")return"json"}}function zg(o,a){let{name:c,attrMap:u}=o;if(c!=="script"||Object.prototype.hasOwnProperty.call(u,"src"))return;let{type:p,lang:f}=o.attrMap;return!f&&!p?"babel":aa(a,{language:f})??Gu(p)}function qg(o,a){if(!al(o,a))return;let{attrMap:c}=o;if(Object.prototype.hasOwnProperty.call(c,"src"))return;let{type:u,lang:p}=c;return aa(a,{language:p})??Gu(u)}function Wg(o,a){if(o.name==="style"){let{lang:c}=o.attrMap;return c?aa(a,{language:c}):"css"}if(o.name==="mj-style"&&a.parser==="mjml")return"css"}function Ku(o,a){return zg(o,a)??Wg(o,a)??qg(o,a)}function jr(o){return o==="block"||o==="list-item"||o.startsWith("table")}function Gg(o){return!jr(o)&&o!=="inline-block"}function Kg(o){return!jr(o)&&o!=="inline-block"}function Yg(o){return!jr(o)}function Zg(o){return!jr(o)}function Qg(o){return!jr(o)&&o!=="inline-block"}function Wi(o){return Yu(o).startsWith("pre")}function Xg(o,a){let c=o;for(;c;){if(a(c))return!0;c=c.parent}return!1}function Jg(o,a){var c;if(Gi(o,a))return"block";if(((c=o.prev)==null?void 0:c.type)==="comment"){let p=o.prev.value.match(/^\s*display:\s*([a-z]+)\s*$/u);if(p)return p[1]}let u=!1;if(o.type==="element"&&o.namespace==="svg")if(Xg(o,p=>p.fullName==="svg:foreignObject"))u=!0;else return o.name==="svg"?"inline-block":"block";switch(a.htmlWhitespaceSensitivity){case"strict":return"inline";case"ignore":return"block";default:if(o.type==="element"&&(!o.namespace||u||Vr(o))&&Object.prototype.hasOwnProperty.call(Pu,o.name))return Pu[o.name]}return kg}function Yu(o){return o.type==="element"&&(!o.namespace||Vr(o))&&Object.prototype.hasOwnProperty.call(Bu,o.name)?Bu[o.name]:Fg}function e0(o){let a=Number.POSITIVE_INFINITY;for(let c of o.split(`
`)){if(c.length===0)continue;let u=En.getLeadingWhitespaceCount(c);if(u===0)return 0;c.length!==u&&u<a&&(a=u)}return a===Number.POSITIVE_INFINITY?0:a}function Zu(o,a=e0(o)){return a===0?o:o.split(`
`).map(c=>c.slice(a)).join(`
`)}function Qu(o){return O(!1,O(!1,o,"&apos;","'"),"&quot;",'"')}function Un(o){return Qu(o.value)}var t0=new Set(["template","style","script"]);function ca(o,a){return Gi(o,a)&&!t0.has(o.fullName)}function Gi(o,a){return a.parser==="vue"&&o.type==="element"&&o.parent.type==="root"&&o.fullName.toLowerCase()!=="html"}function al(o,a){return Gi(o,a)&&(ca(o,a)||o.attrMap.lang&&o.attrMap.lang!=="html")}function n0(o){let a=o.fullName;return a.charAt(0)==="#"||a==="slot-scope"||a==="v-slot"||a.startsWith("v-slot:")}function i0(o,a){let c=o.parent;if(!Gi(c,a))return!1;let u=c.fullName,p=o.fullName;return u==="script"&&p==="setup"||u==="style"&&p==="vars"}function Xu(o,a=o.value){return o.parent.isWhitespaceSensitive?o.parent.isIndentationSensitive?ft(a):ft(Zu($u(a)),Fe):zi(Ne,En.split(a))}function Ju(o,a){return Gi(o,a)&&o.name==="script"}var ed=/\{\{(.+?)\}\}/su;function r0(o,a){return Ce(this,null,function*(){let c=[];for(let[u,p]of o.split(ed).entries())if(u%2===0)c.push(ft(p));else try{c.push(Pe(["{{",Lt([Ne,yield Gt(p,a,{parser:"__ng_interpolation",__isInHtmlInterpolation:!0})]),Ne,"}}"]))}catch{c.push("{{",ft(p),"}}")}return c})}function sl({parser:o}){return(a,c,u)=>Gt(Un(u.node),a,{parser:o},qi)}var o0=sl({parser:"__ng_action"}),a0=sl({parser:"__ng_binding"}),s0=sl({parser:"__ng_directive"});function l0(o,a){if(a.parser!=="angular")return;let{node:c}=o,u=c.fullName;if(u.startsWith("(")&&u.endsWith(")")||u.startsWith("on-"))return o0;if(u.startsWith("[")&&u.endsWith("]")||/^bind(?:on)?-/u.test(u)||/^ng-(?:if|show|hide|class|style)$/u.test(u))return a0;if(u.startsWith("*"))return s0;let p=Un(c);if(/^i18n(?:-.+)?$/u.test(u))return()=>oa(na(Xu(c,p.trim())),!p.includes("@@"));if(ed.test(p))return f=>r0(p,f)}var c0=l0;function u0(o,a){let{node:c}=o,u=Un(c);if(c.fullName==="class"&&!a.parentParser&&!u.includes("{{"))return()=>u.trim().split(/\s+/u).join(" ")}var d0=u0;function td(o){return o==="	"||o===`
`||o==="\f"||o==="\r"||o===" "}var p0=/^[ \t\n\r\u000c]+/,h0=/^[, \t\n\r\u000c]+/,f0=/^[^ \t\n\r\u000c]+/,m0=/[,]+$/,nd=/^\d+$/,g0=/^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/;function v0(o){let a=o.length,c,u,p,f,g,_=0,F;function H(he){let Re,qe=he.exec(o.substring(_));if(qe)return[Re]=qe,_+=Re.length,Re}let P=[];for(;;){if(H(h0),_>=a){if(P.length===0)throw new Error("Must contain one or more image candidate strings.");return P}F=_,c=H(f0),u=[],c.slice(-1)===","?(c=c.replace(m0,""),se()):be()}function be(){for(H(p0),p="",f="in descriptor";;){if(g=o.charAt(_),f==="in descriptor")if(td(g))p&&(u.push(p),p="",f="after descriptor");else if(g===","){_+=1,p&&u.push(p),se();return}else if(g==="(")p+=g,f="in parens";else if(g===""){p&&u.push(p),se();return}else p+=g;else if(f==="in parens")if(g===")")p+=g,f="in descriptor";else if(g===""){u.push(p),se();return}else p+=g;else if(f==="after descriptor"&&!td(g))if(g===""){se();return}else f="in descriptor",_-=1;_+=1}}function se(){let he=!1,Re,qe,Xe,ot,V={},fe,We,Ve,ut,Xi;for(ot=0;ot<u.length;ot++)fe=u[ot],We=fe[fe.length-1],Ve=fe.substring(0,fe.length-1),ut=parseInt(Ve,10),Xi=parseFloat(Ve),nd.test(Ve)&&We==="w"?((Re||qe)&&(he=!0),ut===0?he=!0:Re=ut):g0.test(Ve)&&We==="x"?((Re||qe||Xe)&&(he=!0),Xi<0?he=!0:qe=Xi):nd.test(Ve)&&We==="h"?((Xe||qe)&&(he=!0),ut===0?he=!0:Xe=ut):he=!0;if(!he)V.source={value:c,startOffset:F},Re&&(V.width={value:Re}),qe&&(V.density={value:qe}),Xe&&(V.height={value:Xe}),P.push(V);else throw new Error(`Invalid srcset descriptor found in "${o}" at "${fe}".`)}}var b0=v0;function y0(o){if(o.node.fullName==="srcset"&&(o.parent.fullName==="img"||o.parent.fullName==="source"))return()=>C0(Un(o.node))}var id={width:"w",height:"h",density:"x"},_0=Object.keys(id);function C0(o){let a=b0(o),c=_0.filter(P=>a.some(be=>Object.prototype.hasOwnProperty.call(be,P)));if(c.length>1)throw new Error("Mixed descriptor in srcset is not supported");let[u]=c,p=id[u],f=a.map(P=>P.source.value),g=Math.max(...f.map(P=>P.length)),_=a.map(P=>P[u]?String(P[u].value):""),F=_.map(P=>{let be=P.indexOf(".");return be===-1?P.length:be}),H=Math.max(...F);return oa(zi([",",Ne],f.map((P,be)=>{let se=[P],he=_[be];if(he){let Re=g-P.length+1,qe=H-F[be],Xe=" ".repeat(Re+qe);se.push(Hi(Xe," "),he+p)}return se})))}var w0=y0;function S0(o,a){let{node:c}=o,u=Un(o.node).trim();if(c.fullName==="style"&&!a.parentParser&&!u.includes("{{"))return p=>Ce(null,null,function*(){return oa(yield p(u,{parser:"css",__isHTMLStyleAttribute:!0}))})}var ll=new WeakMap;function D0(o,a){let{root:c}=o;return ll.has(c)||ll.set(c,c.children.some(u=>Ju(u,a)&&["ts","typescript"].includes(u.attrMap.lang))),ll.get(c)}var cl=D0;function x0(o,a,c){let{node:u}=c,p=Un(u);return Gt(`type T<${p}> = any`,o,{parser:"babel-ts",__isEmbeddedTypescriptGenericParameters:!0},qi)}function E0(o,a,{parseWithTs:c}){return Gt(`function _(${o}) {}`,a,{parser:c?"babel-ts":"babel",__isVueBindings:!0})}function T0(o,a,c,u){return Ce(this,null,function*(){let p=Un(c.node),{left:f,operator:g,right:_}=A0(p),F=cl(c,u);return[Pe(yield Gt(`function _(${f}) {}`,o,{parser:F?"babel-ts":"babel",__isVueForBindingLeft:!0}))," ",g," ",yield Gt(_,o,{parser:F?"__ts_expression":"__js_expression"})]})}function A0(o){let a=/(.*?)\s+(in|of)\s+(.*)/su,c=/,([^,\]}]*)(?:,([^,\]}]*))?$/u,u=/^\(|\)$/gu,p=o.match(a);if(!p)return;let f={};if(f.for=p[3].trim(),!f.for)return;let g=O(!1,p[1].trim(),u,""),_=g.match(c);_?(f.alias=g.replace(c,""),f.iterator1=_[1].trim(),_[2]&&(f.iterator2=_[2].trim())):f.alias=g;let F=[f.alias,f.iterator1,f.iterator2];if(!F.some((H,P)=>!H&&(P===0||F.slice(P+1).some(Boolean))))return{left:F.filter(Boolean).join(","),operator:p[2],right:f.for}}function I0(o,a){if(a.parser!=="vue")return;let{node:c}=o,u=c.fullName;if(u==="v-for")return T0;if(u==="generic"&&Ju(c.parent,a))return x0;let p=Un(c),f=cl(o,a);if(n0(c)||i0(c,a))return g=>E0(p,g,{parseWithTs:f});if(u.startsWith("@")||u.startsWith("v-on:"))return g=>k0(p,g,{parseWithTs:f});if(u.startsWith(":")||u.startsWith(".")||u.startsWith("v-bind:"))return g=>F0(p,g,{parseWithTs:f});if(u.startsWith("v-"))return g=>rd(p,g,{parseWithTs:f})}function k0(u,p,f){return Ce(this,arguments,function*(o,a,{parseWithTs:c}){var g;try{return yield rd(o,a,{parseWithTs:c})}catch(_){if(((g=_.cause)==null?void 0:g.code)!=="BABEL_PARSER_SYNTAX_ERROR")throw _}return Gt(o,a,{parser:c?"__vue_ts_event_binding":"__vue_event_binding"},qi)})}function F0(o,a,{parseWithTs:c}){return Gt(o,a,{parser:c?"__vue_ts_expression":"__vue_expression"},qi)}function rd(o,a,{parseWithTs:c}){return Gt(o,a,{parser:c?"__ts_expression":"__js_expression"},qi)}var R0=I0;function M0(o,a){let{node:c}=o;if(c.value){if(/^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/u.test(a.originalText.slice(c.valueSpan.start.offset,c.valueSpan.end.offset))||a.parser==="lwc"&&c.value.startsWith("{")&&c.value.endsWith("}"))return[c.rawName,"=",c.value];for(let u of[w0,S0,d0,R0,c0]){let p=u(o,a);if(p)return L0(p)}}}function L0(o){return(a,c,u,p)=>Ce(null,null,function*(){let f=yield o(a,c,u,p);if(f)return f=$r(f,g=>typeof g=="string"?O(!1,g,'"',"&quot;"):g),[u.node.rawName,'="',Pe(f),'"']})}var O0=M0,N0=new Proxy(()=>{},{get:()=>N0});function Hr(o){return o.sourceSpan.start.offset}function ua(o){return o.sourceSpan.end.offset}function ul(o,a){return[o.isSelfClosing?"":P0(o,a),zr(o,a)]}function P0(o,a){return o.lastChild&&Gr(o.lastChild)?"":[B0(o,a),dl(o,a)]}function zr(o,a){return(o.next?yi(o.next):Wr(o.parent))?"":[qr(o,a),bi(o,a)]}function B0(o,a){return Wr(o)?qr(o.lastChild,a):""}function bi(o,a){return Gr(o)?dl(o.parent,a):da(o)?hl(o.next,a):""}function dl(o,a){if(od(o,a))return"";switch(o.type){case"ieConditionalComment":return"<!";case"element":if(o.hasHtmComponentClosingTag)return"<//";default:return`</${o.rawName}`}}function qr(o,a){if(od(o,a))return"";switch(o.type){case"ieConditionalComment":case"ieConditionalEndComment":return"[endif]-->";case"ieConditionalStartComment":return"]><!-->";case"interpolation":return"}}";case"angularIcuExpression":return"}";case"element":if(o.isSelfClosing)return"/>";default:return">"}}function od(o,a){return!o.isSelfClosing&&!o.endSourceSpan&&(sa(o)||Uu(o.parent,a))}function yi(o){return o.prev&&o.prev.type!=="docType"&&o.type!=="angularControlFlowBlock"&&!Ot(o.prev)&&o.isLeadingSpaceSensitive&&!o.hasLeadingSpaces}function Wr(o){var a;return((a=o.lastChild)==null?void 0:a.isTrailingSpaceSensitive)&&!o.lastChild.hasTrailingSpaces&&!Ot(ol(o.lastChild))&&!Wi(o)}function Gr(o){return!o.next&&!o.hasTrailingSpaces&&o.isTrailingSpaceSensitive&&Ot(ol(o))}function da(o){return o.next&&!Ot(o.next)&&Ot(o)&&o.isTrailingSpaceSensitive&&!o.hasTrailingSpaces}function $0(o){let a=o.trim().match(/^prettier-ignore-attribute(?:\s+(.+))?$/su);return a?a[1]?a[1].split(/\s+/u):!0:!1}function pa(o){return!o.prev&&o.isLeadingSpaceSensitive&&!o.hasLeadingSpaces}function U0(o,a,c){var u;let{node:p}=o;if(!il(p.attrs))return p.isSelfClosing?" ":"";let f=((u=p.prev)==null?void 0:u.type)==="comment"&&$0(p.prev.value),g=typeof f=="boolean"?()=>f:Array.isArray(f)?be=>f.includes(be.rawName):()=>!1,_=o.map(({node:be})=>g(be)?ft(a.originalText.slice(Hr(be),ua(be))):c(),"attrs"),F=p.type==="element"&&p.fullName==="script"&&p.attrs.length===1&&p.attrs[0].fullName==="src"&&p.children.length===0,H=a.singleAttributePerLine&&p.attrs.length>1&&!Gi(p,a)?Fe:Ne,P=[Lt([F?" ":Ne,zi(H,_)])];return p.firstChild&&pa(p.firstChild)||p.isSelfClosing&&Wr(p.parent)||F?P.push(p.isSelfClosing?" ":""):P.push(a.bracketSameLine?p.isSelfClosing?" ":"":p.isSelfClosing?Ne:Ze),P}function V0(o){return o.firstChild&&pa(o.firstChild)?"":fl(o)}function pl(o,a,c){let{node:u}=o;return[Kr(u,a),U0(o,a,c),u.isSelfClosing?"":V0(u)]}function Kr(o,a){return o.prev&&da(o.prev)?"":[_i(o,a),hl(o,a)]}function _i(o,a){return pa(o)?fl(o.parent):yi(o)?qr(o.prev,a):""}var ad="<!doctype";function hl(o,a){switch(o.type){case"ieConditionalComment":case"ieConditionalStartComment":return`<!--[if ${o.condition}`;case"ieConditionalEndComment":return"<!--<!";case"interpolation":return"{{";case"docType":{if(o.value==="html"){let{filepath:u}=a;if(u&&/\.html?$/u.test(u))return ad}let c=Hr(o);return a.originalText.slice(c,c+ad.length)}case"angularIcuExpression":return"{";case"element":if(o.condition)return`<!--[if ${o.condition}]><!--><${o.rawName}`;default:return`<${o.rawName}`}}function fl(o){switch(o.type){case"ieConditionalComment":return"]>";case"element":if(o.condition)return"><!--<![endif]-->";default:return">"}}function j0(o,a){if(!o.endSourceSpan)return"";let c=o.startSourceSpan.end.offset;o.firstChild&&pa(o.firstChild)&&(c-=fl(o).length);let u=o.endSourceSpan.start.offset;return o.lastChild&&Gr(o.lastChild)?u+=dl(o,a).length:Wr(o)&&(u-=qr(o.lastChild,a).length),a.originalText.slice(c,u)}var sd=j0,H0=new Set(["if","else if","for","switch","case"]);function z0(o,a){let{node:c}=o;switch(c.type){case"element":if(Tn(c,a)||c.type==="interpolation")return;if(!c.isSelfClosing&&al(c,a)){let u=Ku(c,a);return u?(p,f)=>Ce(null,null,function*(){let g=sd(c,a),_=/^\s*$/u.test(g),F="";return _||(F=yield p($u(g),{parser:u,__embeddedInHtml:!0}),_=F===""),[_i(c,a),Pe(pl(o,a,f)),_?"":Fe,F,_?"":Fe,ul(c,a),bi(c,a)]}):void 0}break;case"text":if(Tn(c.parent,a)){let u=Ku(c.parent,a);if(u)return p=>Ce(null,null,function*(){let f=u==="markdown"?Zu(c.value.replace(/^[^\S\n]*\n/u,"")):c.value,g={parser:u,__embeddedInHtml:!0};if(a.parser==="html"&&u==="babel"){let _="script",{attrMap:F}=c.parent;F&&(F.type==="module"||(F.type==="text/babel"||F.type==="text/jsx")&&F["data-type"]==="module")&&(_="module"),g.__babelSourceType=_}return[vi,_i(c,a),yield p(f,g),bi(c,a)]})}else if(c.parent.type==="interpolation")return u=>Ce(null,null,function*(){let p={__isInHtmlInterpolation:!0,__embeddedInHtml:!0};return a.parser==="angular"?p.parser="__ng_interpolation":a.parser==="vue"?p.parser=cl(o,a)?"__vue_ts_expression":"__vue_expression":p.parser="__js_expression",[Lt([Ne,yield u(c.value,p)]),c.parent.next&&yi(c.parent.next)?" ":Ne]});break;case"attribute":return O0(o,a);case"front-matter":return u=>gg(c,u);case"angularControlFlowBlockParameters":return H0.has(o.parent.name)?bg:void 0;case"angularLetDeclarationInitializer":return u=>Gt(c.value,u,{parser:"__ng_binding",__isInHtmlAttribute:!1})}}var q0=z0,Yr=null;function Zr(o){if(Yr!==null&&typeof Yr.property){let a=Yr;return Yr=Zr.prototype=null,a}return Yr=Zr.prototype=o??Object.create(null),new Zr}var W0=10;for(let o=0;o<=W0;o++)Zr();function G0(o){return Zr(o)}function K0(o,a="type"){G0(o);function c(u){let p=u[a],f=o[p];if(!Array.isArray(f))throw Object.assign(new Error(`Missing visitor keys for '${p}'.`),{node:u});return f}return c}var Y0=K0,Z0={"front-matter":[],root:["children"],element:["attrs","children"],ieConditionalComment:["children"],ieConditionalStartComment:[],ieConditionalEndComment:[],interpolation:["children"],text:["children"],docType:[],comment:[],attribute:[],cdata:[],angularControlFlowBlock:["children","parameters"],angularControlFlowBlockParameters:["children"],angularControlFlowBlockParameter:[],angularLetDeclaration:["init"],angularLetDeclarationInitializer:[],angularIcuExpression:["cases"],angularIcuCase:["expression"]},Q0=Z0,X0=Y0(Q0),J0=X0,ev="format",tv=/^\s*<!--\s*@(?:noformat|noprettier)\s*-->/u,nv=/^\s*<!--\s*@(?:format|prettier)\s*-->/u;function iv(o){return nv.test(o)}function rv(o){return tv.test(o)}function ov(o){return`<!-- @${ev} -->

${o}`}var av=new Map([["if",new Set(["else if","else"])],["else if",new Set(["else if","else"])],["for",new Set(["empty"])],["defer",new Set(["placeholder","error","loading"])],["placeholder",new Set(["placeholder","error","loading"])],["error",new Set(["placeholder","error","loading"])],["loading",new Set(["placeholder","error","loading"])]]);function ld(o){let a=ua(o);return o.type==="element"&&!o.endSourceSpan&&il(o.children)?Math.max(a,ld(dn(!1,o.children,-1))):a}function Qr(o,a,c){let u=o.node;if(sa(u)){let p=ld(u);return[_i(u,a),ft(En.trimEnd(a.originalText.slice(Hr(u)+(u.prev&&da(u.prev)?hl(u).length:0),p-(u.next&&yi(u.next)?qr(u,a).length:0)))),bi(u,a)]}return c()}function ha(o,a){return Ot(o)&&Ot(a)?o.isTrailingSpaceSensitive?o.hasTrailingSpaces?rl(a)?Fe:Ne:"":rl(a)?Fe:Ze:da(o)&&(sa(a)||a.firstChild||a.isSelfClosing||a.type==="element"&&a.attrs.length>0)||o.type==="element"&&o.isSelfClosing&&yi(a)?"":!a.isLeadingSpaceSensitive||rl(a)||yi(a)&&o.lastChild&&Gr(o.lastChild)&&o.lastChild.lastChild&&Gr(o.lastChild.lastChild)?Fe:a.hasLeadingSpaces?Ne:Ze}function ml(o,a,c){let{node:u}=o;if(ju(u))return[vi,...o.map(f=>{let g=f.node,_=g.prev?ha(g.prev,g):"";return[_?[_,la(g.prev)?Fe:""]:"",Qr(f,a,c)]},"children")];let p=u.children.map(()=>Symbol(""));return o.map((f,g)=>{let _=f.node;if(Ot(_)){if(_.prev&&Ot(_.prev)){let Re=ha(_.prev,_);if(Re)return la(_.prev)?[Fe,Fe,Qr(f,a,c)]:[Re,Qr(f,a,c)]}return Qr(f,a,c)}let F=[],H=[],P=[],be=[],se=_.prev?ha(_.prev,_):"",he=_.next?ha(_,_.next):"";return se&&(la(_.prev)?F.push(Fe,Fe):se===Fe?F.push(Fe):Ot(_.prev)?H.push(se):H.push(Hi("",Ze,{groupId:p[g-1]}))),he&&(la(_)?Ot(_.next)&&be.push(Fe,Fe):he===Fe?Ot(_.next)&&be.push(Fe):P.push(he)),[...F,Pe([...H,Pe([Qr(f,a,c),...P],{id:p[g]})]),...be]},"children")}function sv(o,a,c){let{node:u}=o,p=[];lv(o)&&p.push("} "),p.push("@",u.name),u.parameters&&p.push(" (",Pe(c("parameters")),")"),p.push(" {");let f=cd(u);return u.children.length>0?(u.firstChild.hasLeadingSpaces=!0,u.lastChild.hasTrailingSpaces=!0,p.push(Lt([Fe,ml(o,a,c)])),f&&p.push(Fe,"}")):f&&p.push("}"),Pe(p,{shouldBreak:!0})}function cd(o){var a,c;return!(((a=o.next)==null?void 0:a.type)==="angularControlFlowBlock"&&(c=av.get(o.name))!=null&&c.has(o.next.name))}function lv(o){let{previous:a}=o;return a?.type==="angularControlFlowBlock"&&!sa(a)&&!cd(a)}function cv(o,a,c){return[Lt([Ze,zi([";",Ne],o.map(c,"children"))]),Ze]}function uv(o,a,c){let{node:u}=o;return[Kr(u,a),Pe([u.switchValue.trim(),", ",u.clause,u.cases.length>0?[",",Lt([Ne,zi(Ne,o.map(c,"cases"))])]:"",Ze]),zr(u,a)]}function dv(o,a,c){let{node:u}=o;return[u.value," {",Pe([Lt([Ze,o.map(({node:p,isLast:f})=>{let g=[c()];return p.type==="text"&&(p.hasLeadingSpaces&&g.unshift(Ne),p.hasTrailingSpaces&&!f&&g.push(Ne)),g},"expression")]),Ze]),"}"]}function pv(o,a,c){let{node:u}=o;if(Uu(u,a))return[_i(u,a),Pe(pl(o,a,c)),ft(sd(u,a)),...ul(u,a),bi(u,a)];let p=u.children.length===1&&(u.firstChild.type==="interpolation"||u.firstChild.type==="angularIcuExpression")&&u.firstChild.isLeadingSpaceSensitive&&!u.firstChild.hasLeadingSpaces&&u.lastChild.isTrailingSpaceSensitive&&!u.lastChild.hasTrailingSpaces,f=Symbol("element-attr-group-id"),g=P=>Pe([Pe(pl(o,a,c),{id:f}),P,ul(u,a)]),_=P=>p?el(P,{groupId:f}):(Tn(u,a)||ca(u,a))&&u.parent.type==="root"&&a.parser==="vue"&&!a.vueIndentScriptAndStyle?P:Lt(P),F=()=>p?Hi(Ze,"",{groupId:f}):u.firstChild.hasLeadingSpaces&&u.firstChild.isLeadingSpaceSensitive?Ne:u.firstChild.type==="text"&&u.isWhitespaceSensitive&&u.isIndentationSensitive?Xs(Ze):Ze,H=()=>(u.next?yi(u.next):Wr(u.parent))?u.lastChild.hasTrailingSpaces&&u.lastChild.isTrailingSpaceSensitive?" ":"":p?Hi(Ze,"",{groupId:f}):u.lastChild.hasTrailingSpaces&&u.lastChild.isTrailingSpaceSensitive?Ne:(u.lastChild.type==="comment"||u.lastChild.type==="text"&&u.isWhitespaceSensitive&&u.isIndentationSensitive)&&new RegExp(`\\n[\\t ]{${a.tabWidth*(o.ancestors.length-1)}}$`,"u").test(u.lastChild.value)?"":Ze;return u.children.length===0?g(u.hasDanglingSpaces&&u.isDanglingSpaceSensitive?Ne:""):g([Vg(u)?vi:"",_([F(),ml(o,a,c)]),H()])}function fa(o){return o>=9&&o<=32||o==160}function gl(o){return 48<=o&&o<=57}function ma(o){return o>=97&&o<=122||o>=65&&o<=90}function hv(o){return o>=97&&o<=102||o>=65&&o<=70||gl(o)}function vl(o){return o===10||o===13}function ud(o){return 48<=o&&o<=55}function bl(o){return o===39||o===34||o===96}var fv=/-+([a-z0-9])/g;function mv(o){return o.replace(fv,(...a)=>a[1].toUpperCase())}var yl=class xm{constructor(a,c,u,p){this.file=a,this.offset=c,this.line=u,this.col=p}toString(){return this.offset!=null?`${this.file.url}@${this.line}:${this.col}`:this.file.url}moveBy(a){let c=this.file.content,u=c.length,p=this.offset,f=this.line,g=this.col;for(;p>0&&a<0;)if(p--,a++,c.charCodeAt(p)==10){f--;let _=c.substring(0,p-1).lastIndexOf(`
...
`,Q_={root:"p-ink"},hm=(()=>{class t extends ye{name="ripple";theme=Z_;classes=Q_;static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275prov=I({token:t,factory:t.\u0275fac})}return t})();var Ys=(()=>{class t extends Se{zone=S(gt);_componentStyle=S(hm);animationListener;mouseDownListener;timeout;constructor(){super(),ao(()=>{Zn(this.platformId)&&(this.config.ripple()?this.zone.runOutsideAngular(()=>{this.create(),this.mouseDownListener=this.renderer.listen(this.el.nativeElement,"mousedown",this.onMouseDown.bind(this))}):this.remove())})}ngAfterViewInit(){super.ngAfterViewInit()}onMouseDown(e){let n=this.getInk();if(!n||this.document.defaultView?.getComputedStyle(n,null).display==="none")return;if(wn(n,"p-ink-active"),!su(n)&&!cu(n)){let d=Math.max(Of(this.el.nativeElement),lu(this.el.nativeElement));n.style.height=d+"px",n.style.width=d+"px"}let r=Bf(this.el.nativeElement),s=e.pageX-r.left+this.document.body.scrollTop-cu(n)/2,l=e.pageY-r.top+this.document.body.scrollLeft-su(n)/2;this.renderer.setStyle(n,"top",l+"px"),this.renderer.setStyle(n,"left",s+"px"),Cn(n,"p-ink-active"),this.timeout=setTimeout(()=>{let d=this.getInk();d&&wn(d,"p-ink-active")},401)}getInk(){let e=this.el.nativeElement.children;for(let n=0;n<e.length;n++)if(typeof e[n].className=="string"&&e[n].className.indexOf("p-ink")!==-1)return e[n];return null}resetInk(){let e=this.getInk();e&&wn(e,"p-ink-active")}onAnimationEnd(e){this.timeout&&clearTimeout(this.timeout),wn(e.currentTarget,"p-ink-active")}create(){let e=this.renderer.createElement("span");this.renderer.addClass(e,"p-ink"),this.renderer.appendChild(this.el.nativeElement,e),this.renderer.setAttribute(e,"aria-hidden","true"),this.renderer.setAttribute(e,"role","presentation"),this.animationListener||(this.animationListener=this.renderer.listen(e,"animationend",this.onAnimationEnd.bind(this)))}remove(){let e=this.getInk();e&&(this.mouseDownListener&&this.mouseDownListener(),this.animationListener&&this.animationListener(),this.mouseDownListener=null,this.animationListener=null,$f(e))}ngOnDestroy(){this.config&&this.config.ripple()&&this.remove(),super.ngOnDestroy()}static \u0275fac=function(n){return new(n||t)};static \u0275dir=ne({type:t,selectors:[["","pRipple",""]],hostAttrs:[1,"p-ripple"],features:[ue([hm]),U]})}return t})(),x3=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=re({type:t});static \u0275inj=ie({})}return t})();var X_=["content"],J_=["loadingicon"],eC=["icon"],tC=["*"],gm=t=>({class:t});function nC(t,i){t&1&&He(0)}function iC(t,i){if(t&1&&L(0,"span",8),t&2){let e=D(3);b("ngClass",e.iconClass()),M("aria-hidden",!0)("data-pc-section","loadingicon")}}function rC(t,i){if(t&1&&L(0,"SpinnerIcon",9),t&2){let e=D(3);b("styleClass",e.spinnerIconClass())("spin",!0),M("aria-hidden",!0)("data-pc-section","loadingicon")}}function oC(t,i){if(t&1&&(et(0),k(1,iC,1,3,"span",6)(2,rC,1,4,"SpinnerIcon",7),tt()),t&2){let e=D(2);y(),b("ngIf",e.loadingIcon),y(),b("ngIf",!e.loadingIcon)}}function aC(t,i){}function sC(t,i){if(t&1&&k(0,aC,0,0,"ng-template",10),t&2){let e=D(2);b("ngIf",e.loadingIconTemplate||e._loadingIconTemplate)}}function lC(t,i){if(t&1&&(et(0),k(1,oC,3,2,"ng-container",2)(2,sC,1,1,null,5),tt()),t&2){let e=D();y(),b("ngIf",!e.loadingIconTemplate&&!e._loadingIconTemplate),y(),b("ngTemplateOutlet",e.loadingIconTemplate||e._loadingIconTemplate)("ngTemplateOutletContext",Vt(3,gm,e.iconClass()))}}function cC(t,i){if(t&1&&L(0,"span",8),t&2){let e=D(2);Q(e.icon),b("ngClass",e.iconClass()),M("data-pc-section","icon")}}function uC(t,i){}function dC(t,i){if(t&1&&k(0,uC,0,0,"ng-template",10),t&2){let e=D(2);b("ngIf",!e.icon&&(e.iconTemplate||e._iconTemplate))}}function pC(t,i){if(t&1&&(et(0),k(1,cC,1,4,"span",11)(2,dC,1,1,null,5),tt()),t&2){let e=D();y(),b("ngIf",e.icon&&!e.iconTemplate&&!e._iconTemplate),y(),b("ngTemplateOutlet",e.iconTemplate||e._iconTemplate)("ngTemplateOutletContext",Vt(3,gm,e.iconClass()))}}function hC(t,i){if(t&1&&(x(0,"span",12),De(1),T()),t&2){let e=D();M("aria-hidden",e.icon&&!e.label)("data-pc-section","label"),y(),$e(e.label)}}function fC(t,i){if(t&1&&L(0,"p-badge",13),t&2){let e=D();b("value",e.badge)("severity",e.badgeSeverity)}}var mC=({dt:t})=>`
.p-button {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
...
`,NC={root:"p-card p-component",header:"p-card-header",body:"p-card-body",caption:"p-card-caption",title:"p-card-title",subtitle:"p-card-subtitle",content:"p-card-content",footer:"p-card-footer"},vm=(()=>{class t extends ye{name="card";theme=OC;classes=NC;static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275prov=I({token:t,factory:t.\u0275fac})}return t})();var PC=(()=>{class t extends Se{header;subheader;set style(e){Pi(this._style(),e)||this._style.set(e)}styleClass;headerFacet;footerFacet;headerTemplate;titleTemplate;subtitleTemplate;contentTemplate;footerTemplate;_headerTemplate;_titleTemplate;_subtitleTemplate;_contentTemplate;_footerTemplate;_style=Be(null);_componentStyle=S(vm);getBlockableElement(){return this.el.nativeElement.children[0]}templates;ngAfterContentInit(){this.templates.forEach(e=>{switch(e.getType()){case"header":this._headerTemplate=e.template;break;case"title":this._titleTemplate=e.template;break;case"subtitle":this._subtitleTemplate=e.template;break;case"content":this._contentTemplate=e.template;break;case"footer":this._footerTemplate=e.template;break;default:this._contentTemplate=e.template;break}})}static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275cmp=W({type:t,selectors:[["p-card"]],contentQueries:function(n,r,s){if(n&1&&(pe(s,Kf,5),pe(s,Yf,5),pe(s,vC,4),pe(s,bC,4),pe(s,yC,4),pe(s,_C,4),pe(s,CC,4),pe(s,qt,4)),n&2){let l;ee(l=te())&&(r.headerFacet=l.first),ee(l=te())&&(r.footerFacet=l.first),ee(l=te())&&(r.headerTemplate=l.first),ee(l=te())&&(r.titleTemplate=l.first),ee(l=te())&&(r.subtitleTemplate=l.first),ee(l=te())&&(r.contentTemplate=l.first),ee(l=te())&&(r.footerTemplate=l.first),ee(l=te())&&(r.templates=l)}},inputs:{header:"header",subheader:"subheader",style:"style",styleClass:"styleClass"},features:[ue([vm]),U],ngContentSelectors:SC,decls:9,vars:10,consts:[[3,"ngClass","ngStyle"],["class","p-card-header",4,"ngIf"],[1,"p-card-body"],["class","p-card-title",4,"ngIf"],["class","p-card-subtitle",4,"ngIf"],[1,"p-card-content"],[4,"ngTemplateOutlet"],["class","p-card-footer",4,"ngIf"],[1,"p-card-header"],[1,"p-card-title"],[4,"ngIf"],[1,"p-card-subtitle"],[1,"p-card-footer"]],template:function(n,r){n&1&&(pt(wC),x(0,"div",0),k(1,xC,3,1,"div",1),x(2,"div",2),k(3,AC,3,2,"div",3)(4,FC,3,2,"div",4),x(5,"div",5),nt(6),k(7,RC,1,0,"ng-container",6),T(),k(8,LC,3,1,"div",7),T()()),n&2&&(Q(r.styleClass),b("ngClass","p-card p-component")("ngStyle",r._style()),M("data-pc-name","card"),y(),b("ngIf",r.headerFacet||r.headerTemplate||r._headerTemplate),y(2),b("ngIf",r.header||r.titleTemplate||r._titleTemplate),y(),b("ngIf",r.subheader||r.subtitleTemplate||r._subtitleTemplate),y(3),b("ngTemplateOutlet",r.contentTemplate||r._contentTemplate),y(),b("ngIf",r.footerFacet||r.footerTemplate||r._footerTemplate))},dependencies:[we,ht,Ke,xt,tn,de],encapsulation:2,changeDetection:0})}return t})(),dR=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=re({type:t});static \u0275inj=ie({imports:[PC,de,de]})}return t})();function BC(t,i){if(t&1){let e=Ae();x(0,"div",3)(1,"p-radioButton",4),ar("ngModelChange",function(r){K(e);let s=D();return or(s.selected,r)||(s.selected=r),Y(r)}),J("ngModelChange",function(r){K(e);let s=D();return Y(s.onChange(r))}),T(),x(2,"label",5),L(3,"i"),De(4),Me(5,"translate"),T()()}if(t&2){let e=i.$implicit,n=i.index,r=D();y(),b("inputId",r.name+"-"+n)("name",r.name)("value",e.value),rr("ngModel",r.selected),y(),b("for",r.name+"-"+n),y(),Q(e.icon),y(),vt(" ",Le(5,8,e.label)," ")}}var bm=class t{label;name;options=[];selected;selectedChange=new G;onChange(i){this.selectedChange.emit(i)}static \u0275fac=function(e){return new(e||t)};static \u0275cmp=W({type:t,selectors:[["ca-horizontal-radio-buttons"]],inputs:{label:"label",name:"name",options:"options",selected:"selected"},outputs:{selectedChange:"selectedChange"},decls:6,vars:7,consts:[[1,"mb-1","font-semibold","block",3,"for"],["role","radiogroup",1,"flex","flex-wrap","gap-3"],["class","field-radiobutton",4,"ngFor","ngForOf"],[1,"field-radiobutton"],[3,"ngModelChange","inputId","name","value","ngModel"],[3,"for"]],template:function(e,n){e&1&&(x(0,"div")(1,"label",0),De(2),Me(3,"translate"),T(),x(4,"div",1),k(5,BC,6,10,"div",2),T()()),e&2&&(y(),b("for",n.name+"-0"),M("id",n.name+"-label"),y(),$e(Le(3,5,n.label)),y(2),M("aria-labelledby",n.name+"-label"),y(),b("ngForOf",n.options))},dependencies:[we,sr,si,Fr,sn,ei,Jn,Gs],encapsulation:2})};var ym=`
<!DOCTYPE html>
...
`,VC={root:({instance:t,props:i})=>["p-inputtext p-component",{"p-filled":t.filled,"p-inputtext-sm":i.size==="small","p-inputtext-lg":i.size==="large","p-invalid":i.invalid,"p-variant-filled":i.variant==="filled","p-inputtext-fluid":i.fluid}]},Fm=(()=>{class t extends ye{name="inputtext";theme=UC;classes=VC;static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275prov=I({token:t,factory:t.\u0275fac})}return t})();var Rm=(()=>{class t extends Se{ngModel;variant;fluid;pSize;filled;_componentStyle=S(Fm);get hasFluid(){let n=this.el.nativeElement.closest("p-fluid");return it(this.fluid)?!!n:this.fluid}constructor(e){super(),this.ngModel=e}ngAfterViewInit(){super.ngAfterViewInit(),this.updateFilledState(),this.cd.detectChanges()}ngDoCheck(){this.updateFilledState()}onInput(){this.updateFilledState()}updateFilledState(){this.filled=this.el.nativeElement.value&&this.el.nativeElement.value.length||this.ngModel&&this.ngModel.model}static \u0275fac=function(n){return new(n||t)(B(sn,8))};static \u0275dir=ne({type:t,selectors:[["","pInputText",""]],hostAttrs:[1,"p-inputtext","p-component"],hostVars:14,hostBindings:function(n,r){if(n&1&&J("input",function(l){return r.onInput(l)}),n&2){let s;_t("p-filled",r.filled)("p-variant-filled",((s=r.variant)!==null&&s!==void 0?s:r.config.inputStyle()||r.config.inputVariant())==="filled")("p-inputtext-fluid",r.hasFluid)("p-inputtext-sm",r.pSize==="small")("p-inputfield-sm",r.pSize==="small")("p-inputtext-lg",r.pSize==="large")("p-inputfield-lg",r.pSize==="large")}},inputs:{variant:"variant",fluid:[2,"fluid","fluid",j],pSize:"pSize"},features:[ue([Fm]),U]})}return t})(),Mm=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=re({type:t});static \u0275inj=ie({})}return t})();var HC=["*"],zC=({dt:t})=>`
.p-inputgroup,
...
`,qC={root:({props:t})=>["p-inputgroup",{"p-inputgroup-fluid":t.fluid}]},Lm=(()=>{class t extends ye{name="inputgroup";theme=zC;classes=qC;static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275prov=I({token:t,factory:t.\u0275fac})}return t})();var Su=(()=>{class t extends Se{style;styleClass;_componentStyle=S(Lm);static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275cmp=W({type:t,selectors:[["p-inputgroup"],["p-inputGroup"],["p-input-group"]],hostAttrs:[1,"p-inputgroup"],hostVars:5,hostBindings:function(n,r){n&2&&(M("data-pc-name","inputgroup"),Xt(r.style),Q(r.styleClass))},inputs:{style:"style",styleClass:"styleClass"},features:[ue([Lm]),U],ngContentSelectors:HC,decls:1,vars:0,template:function(n,r){n&1&&(pt(),nt(0))},dependencies:[we,de],encapsulation:2})}return t})(),Om=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=re({type:t});static \u0275inj=ie({imports:[Su,de,de]})}return t})();var GC=["*"],KC={root:"p-inputgroupaddon"},Nm=(()=>{class t extends ye{name="inputgroupaddon";classes=KC;static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275prov=I({token:t,factory:t.\u0275fac})}return t})(),Du=(()=>{class t extends Se{style;styleClass;_componentStyle=S(Nm);get hostStyle(){return this.style}static \u0275fac=(()=>{let e;return function(r){return(e||(e=R(t)))(r||t)}})();static \u0275cmp=W({type:t,selectors:[["p-inputgroup-addon"],["p-inputGroupAddon"]],hostVars:7,hostBindings:function(n,r){n&2&&(M("data-pc-name","inputgroupaddon"),Xt(r.hostStyle),Q(r.styleClass),_t("p-inputgroupaddon",!0))},inputs:{style:"style",styleClass:"styleClass"},features:[ue([Nm]),U],ngContentSelectors:GC,decls:1,vars:0,template:function(n,r){n&1&&(pt(),nt(0))},dependencies:[we],encapsulation:2})}return t})(),Pm=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=re({type:t});static \u0275inj=ie({imports:[Du,de,de]})}return t})();var ZC=["container"],QC=["icon"],XC=["closeicon"],JC=["*"],ew=(t,i)=>({showTransitionParams:t,hideTransitionParams:i}),tw=t=>({value:"visible()",params:t}),nw=t=>({closeCallback:t});function iw(t,i){t&1&&He(0)}function rw(t,i){if(t&1&&k(0,iw,1,0,"ng-container",7),t&2){let e=D(2);b("ngTemplateOutlet",e.iconTemplate||e.iconTemplate)}}function ow(t,i){if(t&1&&L(0,"i",3),t&2){let e=D(2);b("ngClass",e.icon)}}function aw(t,i){if(t&1&&L(0,"span",9),t&2){let e=D(3);b("ngClass",e.cx("text"))("innerHTML",e.text,Aa)}}function sw(t,i){if(t&1&&(x(0,"div"),k(1,aw,1,2,"span",8),T()),t&2){let e=D(2);y(),b("ngIf",!e.escape)}}function lw(t,i){if(t&1&&(x(0,"span",5),De(1),T()),t&2){let e=D(3);b("ngClass",e.cx("text")),y(),$e(e.text)}}function cw(t,i){if(t&1&&k(0,lw,2,2,"span",10),t&2){let e=D(2);b("ngIf",e.escape&&e.text)}}function uw(t,i){t&1&&He(0)}function dw(t,i){if(t&1&&k(0,uw,1,0,"ng-container",11),t&2){let e=D(2);b("ngTemplateOutlet",e.containerTemplate||e.containerTemplate)("ngTemplateOutletContext",Vt(2,nw,e.close.bind(e)))}}function pw(t,i){if(t&1&&(x(0,"span",5),nt(1),T()),t&2){let e=D(2);b("ngClass",e.cx("text"))}}function hw(t,i){if(t&1&&L(0,"i",13),t&2){let e=D(3);b("ngClass",e.closeIcon)}}function fw(t,i){t&1&&He(0)}function mw(t,i){if(t&1&&k(0,fw,1,0,"ng-container",7),t&2){let e=D(3);b("ngTemplateOutlet",e.closeIconTemplate||e._closeIconTemplate)}}function gw(t,i){t&1&&L(0,"TimesIcon",14)}function vw(t,i){if(t&1){let e=Ae();x(0,"button",12),J("click",function(r){K(e);let s=D(2);return Y(s.close(r))}),k(1,hw,1,1,"i",13)(2,mw,1,1,"ng-container")(3,gw,1,0,"TimesIcon",14),T()}if(t&2){let e=D(2);M("aria-label",e.closeAriaLabel),y(),lt(e.closeIcon?1:-1),y(),lt(e.closeIconTemplate||e._closeIconTemplate?2:-1),y(),lt(!e.closeIconTemplate&&!e._closeIconTemplate&&!e.closeIcon?3:-1)}}function bw(t,i){if(t&1&&(x(0,"div",1)(1,"div",2),k(2,rw,1,1,"ng-container")(3,ow,1,1,"i",3)(4,sw,2,1,"div",4)(5,cw,1,1,"ng-template",null,0,mn)(7,dw,1,4,"ng-container")(8,pw,2,1,"span",5)(9,vw,4,4,"button",6),T()()),t&2){let e=Ut(6),n=D();b("ngClass",n.containerClass)("@messageAnimation",Vt(13,tw,Fa(10,ew,n.showTransitionOptions,n.hideTransitionOptions))),M("aria-live","polite")("role","alert"),y(2),lt(n.iconTemplate||n._iconTemplate?2:-1),y(),lt(n.icon?3:-1),y(),b("ngIf",!n.escape)("ngIfElse",e),y(3),lt(n.containerTemplate||n._containerTemplate?7:8),y(2),lt(n.closable?9:-1)}}var yw=({dt:t})=>`
.p-message {
